...
\setlength{\footskip}{25pt} % space for the footer
...
\fancyhead[C]{
	...
	\begin{tikzpicture}
		...
		\node at (\textwidth/2-1cm,0.5cm) {\large\textbf{\textcolor{white}{2024 ACM ICPC BIRJAND PROVINCIAL CONTEST}}};
	\end{tikzpicture}
}
...
\def\folderlist{1,5,2,3,4,10,7,6,9,8} % فرض کرده‌ام که سه پوشه دارید
...
\begin{document}
	...
	\fancyfoot[C]{} % This clears the center 
